...
krRV_examples = [
  {
    ...
    "ex_description": "조리를 쉽고 빠르게 할 수 있는 것은 고객이 하루에 한끼 정도는 요리를 할 수 있게 만드는 요소입니다. 현재대비 50% 정도로 요리 과정이 간소화되어야 하는데, 현재가 어느정도인지 나타나지 않아서 50%로 줄어드는 것을 측정하기 어렵다. 조리과정 50% 감소라는 것은 결과이나, 조리과정이 현재 어느정도에서 얼마나 달라지는지로 표현되어야 더 좋은 결과다",
...
krRV_example_prompt = PromptTemplate(
  input_variables = ["guideline", "input_sentence", "upper_objective", "ex_description", "predict_value_score", "description", "revision"],
  template = """
  "guideline" : {guideline}
...
krRV_examples_1 = [
  {
    ...
    "input_sentence" : "일상 요리들의 조리 과정을 50% 줄일 수 있는 제품+요리법을 연구, 개발한다.",
    "upper_objective" : "고객이 하루에 한 끼는 요리를 하고 싶게 한다.",
    "ex_description": "조리를 쉽고 빠르게 할 수 있는 것은 고객이 하루에 한끼 정도는 요리를 할 수 있게 만드는 요소입니다.",
    "description": "추가 필요",
    "revision" : "추가 필요",
  }
]
