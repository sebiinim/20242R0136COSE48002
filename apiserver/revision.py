...
### Flask 관련 코드
Revision = Namespace(name='polyglot-ko', description='revision')

revision_fields = Revision.model('revision', {
...
class revisionResource(Resource):
    @Revision.expect(revision_fields)
    def post(self):
