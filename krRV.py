from krRVprompt import krRV_example_prompt, krRV_examples, krRV_examples_1, krRV_examples_2, krRV_examples_3, krRV_suffix, krRV_task_description, kr_background_template
...
def krRV(df_data, index, isguide, isexample):
  ...
  # print(krRV)
  # 결과 저장, 문자열 메소드 이용
  krRVsaveResult(df_data, index, krRV)
  ...
  return f"""
  revision : {df_data.loc[index, 'predict_revision_description']},
  description : {df_data.loc[index, 'predict_revision']}
  """
